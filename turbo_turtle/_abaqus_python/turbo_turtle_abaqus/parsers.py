...
def cylinder_parser(basename="cylinder.py", add_help=True, description=cylinder_cli_description, cubit=False):
    ...
    optional.add_argument("--revolution-angle", type=float, default=geometry_defaults["revolution_angle"],
                          help="Revolution angle for a 3D part in degrees (default: %(default)s)")
    optional.add_argument("--y-offset", type=float, default=cylinder_defaults["y_offset"],
...
sphere_defaults["center"] = (0., sphere_defaults["y_offset"])
...
def mesh_parser(basename="mesh_module.py", add_help=True, description=mesh_cli_description, cubit=False):
    ...
    optional.add_argument(
        ...
        help="Edge seed (name, number) pairs. Repeat once per edge set. Not yet implemented for Cubit (default: %(default)s)"
    )
...
def image_parser(basename="image.py", add_help=True, description=image_cli_description, cubit=False):
    ...
    optional = parser.add_argument_group('optional arguments')
    optional.add_argument('--x-angle', type=float, default=image_defaults["x_angle"],
                          help='Viewer rotation about X-axis in degrees (default: %(default)s)')
    optional.add_argument('--y-angle', type=float, default=image_defaults["y_angle"],
    ...
    optional.add_argument('--part-name', type=str, default=image_defaults["part_name"],
                          help=part_name_help)
